...
import('./gen_science.js').then(() => {
import('./gen_math.js').then(() => {
import('./gen_english.js').then(() => {
import('./gen_gk.js').then(() => {
import('./gen_social.js').then(() => {
import('./gen_hindi.js').then(() => {
  ...
  console.log('Total Assembled Questions:', allQuestions.length);
