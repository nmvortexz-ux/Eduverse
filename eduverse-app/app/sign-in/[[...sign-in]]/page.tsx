    ...
    >
      ...
      <div className="mb-8 text-center relative z-10 space-y-2">
        ...
        <p className="text-xs font-bold uppercase tracking-wider text-slate-400">
          Intelligent NCERT Assessment Engine
        </p>
      </div>

      {/* Clerk SignIn Component with Dark Retro-Pop Styling */}
        ...
        <SignIn
          appearance={{
            ...
            elements: {
              ...
              identityPreview: 'bg-slate-800 border border-slate-700 rounded-xl p-2',
